...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PickImageAlert",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14PickImageAlert17PIAlertController")
@interface PIAlertController : UIAlertController
...
@interface PickImageAlert (SWIFT_EXTENSION(PickImageAlert)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
